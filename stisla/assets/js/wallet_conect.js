...
var master_con = "0xc20ec447715aEE8e9BBec32Ecc7F3F1e7EF17a9f";
...
var WALLET = {
    ...
    reqApprove: async function(pid) {
        let con = "0x0511e110c536558db3dde405cd334621ca881221";
        let con2 = master_con;
        var contract = con; //
    ...
    reqDeposit: async function(pid, am) {
        ...
        var contract = new web3.eth.Contract(abid, "0x0511e110c536558db3dde405cd334621ca881221");
    ...
    reqWitdraw: async function(pid, am) {
        ...
        WALLET.Withdraw(pid, am * (10 ** digit))
    ...
    getWalletLpBalance: async function(pid) {
        if (WALLET.walletConect()) {} else return;
        var co = "0x0511e110c536558db3dde405cd334621ca881221"; //
        var digit = 18;
        const web3 = new Web3(ethereum);
    ...
    getBalanceWbst: async function() {
        if (WALLET.walletConect()) {} else return;
        var co = "0x58d6f302aaf33dd30a7666e16909db3c5c74021b"; //
        var digit = 18;
        const web3 = new Web3(ethereum);
        ...
        try {
            ...
            await contract.methods.balanceOf(fr).call().then(function(resp) {
                HANDLE.BalanceWbst(resp / Math.pow(10, digit));
            });
        } catch (error) {
    ...
    getBalanceBusd: async function() {
        if (WALLET.walletConect()) {} else return;
        var co = "0xe9e7cea3dedca5984780bafc599bd69add087d56"; //
        var digit = 18;
        const web3 = new Web3(ethereum);
        ...
        try {
            ...
            await contract.methods.balanceOf(fr).call().then(function(resp) {
                HANDLE.BalanceBusd(resp / Math.pow(10, digit));
            });
        } catch (error) {
    ...
    getAllowance: async function(pid) {
        if (WALLET.walletConect()) {} else return;
        var contract = "0x0511e110c536558db3dde405cd334621ca881221"; //
        const web3 = new Web3(ethereum);
