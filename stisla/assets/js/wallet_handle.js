...
var HANDLE = {
    ...
    BalanceWbst: function(res) {

        if ($('.balance-wbst').length > 0) {
            var x = 0;
            for (x = 0; x < $('.balance-wbst').length; x++) {
                $('.balance-wbst')[x].innerHTML = number_format(res, 8);
            }
        }

    },
    BalanceBusd: function(res) {

        if ($('.balance-busd').length > 0) {
            var x = 0;
            for (x = 0; x < $('.balance-busd').length; x++) {
                $('.balance-busd')[x].innerHTML = number_format(res, 8);
            }
        }
